-- Rollback de 202609251700 : restaure fill_subscription_client() exactement
-- comme défini dans 202609251500 (sans le garde-fou "not exists" — à ne faire
-- que si 202609251700 elle-même doit être annulée, pas 202609251500, qui
-- reste le comportement voulu pour la création d'une nouvelle entreprise).
