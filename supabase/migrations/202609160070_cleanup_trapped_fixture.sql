...
-- Nettoyage du compte de test utilisé pour vérifier en direct le blocage
-- "abonnement expiré" sans issue (16/09).
...
delete from public.companies where name = 'Trapped Test Co';
...
delete from auth.users where email = 'moustapha.amir.diallo+trapped@gmail.com';
