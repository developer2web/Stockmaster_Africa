...
-- Nettoyage du compte de test utilisé pour vérifier en direct la réduction
-- des boutons rouges redondants (15/09, côté app mobile).
...
delete from public.companies where name = 'RedQA Co';
...
delete from auth.users where email = 'moustapha.amir.diallo+redqa@gmail.com';
