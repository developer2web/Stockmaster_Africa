...
-- obligatoire (mobile) sur la suppression de rôle et d'employé (15/09).
...
delete from public.companies where name = 'ReasonQA Co';
...
delete from auth.users where email in (
  'moustapha.amir.diallo+reasonqa@gmail.com',
  'moustapha.amir.diallo+reasonqaemp@gmail.com'
);
