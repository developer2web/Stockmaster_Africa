...
-- du bloc « Vendre aussi en gros » sur la fiche produit (15/09). Même
-- mécanisme que les nettoyages précédents.
...
delete from public.companies where name = 'Form Check Co';
...
delete from auth.users where email = 'moustapha.amir.diallo+formcheck@gmail.com';
