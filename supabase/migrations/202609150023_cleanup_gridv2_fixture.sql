...
-- Nettoyage du compte de test utilisé pour vérifier en direct la refonte
-- de la grille produits sur l'écran de vente (15/09, 2e itération après
-- retour visuel). Même mécanisme que les nettoyages précédents.
...
delete from public.companies where name = 'Grid V2 Co';
...
delete from auth.users where email = 'moustapha.amir.diallo+gridv2@gmail.com';
