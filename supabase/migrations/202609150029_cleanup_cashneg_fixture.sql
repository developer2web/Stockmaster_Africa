...
-- Nettoyage du compte de test utilisé pour vérifier en direct
-- l'avertissement de caisse négative sur un approvisionnement (15/09).
-- Même mécanisme que les nettoyages précédents.
...
delete from public.companies where name = 'CashNeg Co';
...
delete from auth.users where email = 'moustapha.amir.diallo+cashneg@gmail.com';
