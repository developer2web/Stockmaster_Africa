...
-- Nettoyage du compte de test utilisé pour vérifier en direct la vente en
-- gros/détail (15/09). Même mécanisme que les nettoyages précédents.
...
delete from public.companies where name = 'Bulk Test Co';
...
delete from auth.users where email = 'moustapha.amir.diallo+bulktest@gmail.com';
