...
-- Nettoyage du compte de test utilisé pour vérifier en direct la
-- détection de produits en doublon (15/09). Même mécanisme que les
...
delete from public.companies where name = 'Dup Test Co';
...
delete from auth.users where email = 'moustapha.amir.diallo+duptest@gmail.com';
