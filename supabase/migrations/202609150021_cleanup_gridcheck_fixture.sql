...
-- Nettoyage du compte de test utilisé pour vérifier en direct la grille
-- produits sur l'écran de vente (15/09). Même mécanisme que les
...
delete from public.companies where name = 'Grid Check Co';
...
delete from auth.users where email = 'moustapha.amir.diallo+gridcheck@gmail.com';
