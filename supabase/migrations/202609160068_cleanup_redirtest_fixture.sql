...
-- redirection post-connexion public-web -> account-web (16/09).
...
delete from public.companies where name = 'Redir Test Co';
...
delete from auth.users where email = 'moustapha.amir.diallo+redirtest@gmail.com';
