...
-- Nettoyage du compte de test utilisé pour vérifier en direct le vidage
-- automatique du panier après 5 minutes d'inactivité (15/09).
...
delete from public.companies where name = 'Cart Idle Co';
...
delete from auth.users where email = 'moustapha.amir.diallo+cartidle@gmail.com';
