...
-- Nettoyage du compte de test utilisé pour vérifier en direct la nouvelle
-- suppression de compte employé (15/09). L'employé jetable a déjà été
-- supprimé pendant le test lui-même ; il ne reste que le propriétaire et
-- son entreprise. Même mécanisme que les nettoyages précédents.
...
delete from public.companies where name = 'Del Verify Co';
...
delete from auth.users where email = 'moustapha.amir.diallo+delverify@gmail.com';
