...
-- Nettoyage du compte de test utilisé pour vérifier en direct la pagination
-- par curseur (produits ET ventes, 15/09) : 35 produits, 5 ventes réelles,
-- deux appels API directs (35 produits en une page de 30 puis le reste, une
-- combinaison recherche+curseur, 5 ventes en pages de 2) confirmant en
-- direct zéro doublon et zéro trou entre les pages.
...
delete from public.companies where name = 'KeysetQA Co';
...
delete from auth.users where email = 'moustapha.amir.diallo+keysetqa@gmail.com';
