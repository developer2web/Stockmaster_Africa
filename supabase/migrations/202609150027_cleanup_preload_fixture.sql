...
-- pré-remplissage des prix à l'unité depuis les prix du lot (15/09).
...
delete from public.companies where name = 'Preload Co';
...
delete from auth.users where email = 'moustapha.amir.diallo+preload@gmail.com';
