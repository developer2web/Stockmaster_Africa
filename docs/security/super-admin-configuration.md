...
5. Dans **Super Admin → Paramètres → Général**, cliquer sur **Vérifier la configuration email**. Ce contrôle vérifie la présence des paramètres et le format de l’expéditeur ; il ne garantit pas l’autorisation de la clé, le domaine DNS ni la réception.
