...
export default function EmployeeEntry() {
  ...
  const modules = [
    ...
    { title: 'Sécurité', description: 'Modifier mon mot de passe', icon: 'shield-key-outline', accent: '#E64980', route: '/employee/security' },
...
function EmployeeLogin() {
  ...
  return (
    <AuthScreen title="Espace employé" subtitle="Accédez à votre espace de travail.">
      ...
      <AppButton mode="text" icon="arrow-left" onPress={() => router.replace('/(auth)/login')}>Retour au choix de l’espace</AppButton>
    </AuthScreen>
  );
}
