...
export default function EmployeeSettings() {
  ...
  return <RoleGuard roles={['employee']}><AdminPage title="Paramètres">
    ...
    {/* Revue du 26/09 : une seule option dans Zone sensible côté employé — l'ancien
        AccountDeletionCard (routé Super Admin) a été retiré d'ici, RequestAccessRemovalCard
        porte désormais le libellé "Supprimer mon compte" et notifie l'administrateur de
        l'entreprise. Reste inchangé, séparément, dans (settings)/index.tsx côté admin. */}
