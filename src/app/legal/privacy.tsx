...
export default function PrivacyScreen() {
  return (
    <LegalPage title="Politique de confidentialité" updatedAt="21 août 2026">
      ...
      <Text style={legalStyles.paragraph}>Les données sont conservées pendant la relation contractuelle puis pendant la durée nécessaire aux finalités décrites. Après une demande de suppression de compte, l’identité de la personne (nom, photo, email, moyen de connexion) est définitivement supprimée. Les ventes, produits, mouvements de stock et autres données déjà enregistrées pour l’entreprise restent conservés pour sa comptabilité, sans nom rattaché. Les pièces comptables, paiements, traces de sécurité et éléments utiles à une obligation légale, à la prévention de la fraude ou à un litige peuvent être conservés pendant la durée légalement applicable, avec accès restreint. Les sauvegardes sont purgées selon le cycle technique de l’hébergeur.</Text>
