...
export default function RolesScreen() {
  ...
  const presets = [
    { label: 'Manager', codes: ['notifications.read','stores.read','stores.write','products.read','products.write','suppliers.read','suppliers.write','product_variants.read','product_variants.write','stock_movements.read','stock_movements.write','sales.read','sales.write','expenses.read','expenses.write','cash_transactions.read','cash_transactions.write','cash_transactions.override_negative_balance','cash.open','cash.reopen','daily_reports.read','monthly_reports.read'] },
