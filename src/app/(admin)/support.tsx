...
export default function SupportScreen() {
  ...
  return <AdminPage title="Centre d’assistance" action={<AppButton compact icon="plus" onPress={() => setOpen(true)}>Nouvelle demande</AppButton>}>
    ...
    <Card mode="outlined"><Card.Content style={{ gap: 10 }}>
      ...
      <View>
        <TextInput mode="outlined" label="Rechercher dans l’aide" accessibilityLabel="Rechercher dans l’aide" value={faqSearch} onChangeText={setFaqSearch} left={<TextInput.Icon icon="magnify" />} />
