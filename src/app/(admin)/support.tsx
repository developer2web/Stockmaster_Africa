...
export default function SupportScreen() {
  ...
  const create = useMutation({ mutationFn: () => createTicket(company,subject,description,priority!), onSuccess: async () => {
