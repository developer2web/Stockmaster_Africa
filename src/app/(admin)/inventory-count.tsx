...
export default function InventoryCountScreen(){
  ...
  // un écart qui n'a rien de physique. Resynchronisation explicite plutôt
  // qu'automatique : ne pas faire bouger la base de comparaison pendant que
  // l'utilisateur compte.
  const refresh=useMutation({mutationFn:()=>refreshInventoryExpectedQuantities(id),onSuccess:()=>inventory.refetch()});
