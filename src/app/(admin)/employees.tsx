...
export default function EmployeesScreen() {
  ...
  const removeAccount = useMutation({mutationFn:()=>deleteEmployeeAccount(editing!.id),onSuccess:async()=>{await qc.invalidateQueries({queryKey:['employees',companyId]});setDeleteAccountConfirm(false);setEditing(null)}});
