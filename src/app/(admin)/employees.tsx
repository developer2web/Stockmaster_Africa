...
export default function EmployeesScreen() {
  ...
  return <AdminPage title="Employés" action={<FAB size="small" icon={canInvite?'account-plus':'lock-outline'} onPress={()=>canInvite?openInvite():router.push('/(subscription)' as never)}/> }>
