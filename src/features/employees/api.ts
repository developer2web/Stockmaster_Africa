...
export async function inviteEmployee(values: EmployeeInput, companyId: string): Promise<EmployeeInviteResult> {
  ...
  return {
    ...
    temporaryPassword: typeof data.temporaryPassword === 'string' ? data.temporaryPassword : null,
