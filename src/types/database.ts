...
export interface SaleStockItem { stockLevelId:string; productId:string; variantId:string|null; unit:ProductUnit; name:string; sku:string; lookupCodes:string[]; salePrice:number; purchasePrice:number; available:number; imageUrl:string|null }
