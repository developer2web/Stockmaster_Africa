...
export interface SaleStockItem { stockLevelId:string; productId:string; variantId:string|null; categoryId:string|null; categoryName:string|null; unit:ProductUnit; name:string; sku:string; lookupCodes:string[]; salePrice:number; purchasePrice:number; available:number; imageUrl:string|null }
