...
export interface StockLevel { id:string; company_id:string; store_id:string; product_id:string; product_variant_id:string|null; quantity:number; updated_at:string; store?:{name:string}|null; product?:{name:string;sku:string;purchase_price?:number;sale_price?:number;is_active:boolean}|null; variant?:{name:string;sku:string}|null }
